  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div id="createNewMember">
        <h1>Create Client</h1>
        <div class="input-group">
          <input type="text" name="email" class="form-control" placeholder="Client First Name" id="fName">
        </div>
        <div class="input-group">
          <input type="text" name="password" class="form-control" placeholder="Client Last Name" id="lName">
        </div>
        <input class="btn btn-primary waves-effect waves-light" id="submit" onClick=runCreateClient() type="button" value="Submit">
      </div>

      <script>
        function runCreateClient(){
          var getEmail = document.getElementById('fName').value;
          var getPass = document.getElementById('lName').value
          if (getEmail == "" || getPass == ""){
